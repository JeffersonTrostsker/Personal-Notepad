...
public interface ServicoUsuario {
	...
	/*
	 * A remoção de um usuário deve remover os contatos associados, via chamada de
	 * serviço de contatos.
	 */
	public boolean removerUsuario(Usuario u);

	/*
	 * Uma atualização de usuário pode, por exemplo, simplesmente alterar os seus
	 * contatos, afetando a lista do objeto e os arquivos de dados.
	 */
	public Usuario atualizarUsuario(Usuario uAnt, Usuario uAtual);

	/*
	 * monta uma lista de objetos completos de usuário, contendo inclusive todos os
	 * contatos de cada usuário
	 */
